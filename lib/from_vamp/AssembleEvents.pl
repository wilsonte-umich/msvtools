...
###################################################################
#AssembleEvents finds all genome segments corresponding to
#overlapping Sets and commits them as Events, a proces which entails
#'chaining' to identify segments of predicted copy number change.
#Events carry a type corresponding to the binary addition of all
#Set types it contains.
###################################################################
